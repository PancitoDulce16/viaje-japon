...
- **Slice 3 — not started.** Likely candidate: wiring slices 1+2 into the real `dashboard.html` with live trip data (still not navigation — per explicit instruction, nav consolidation waits until the Dashboard Experience itself feels complete).
