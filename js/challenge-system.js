...
class ChallengeSystem {
  ...
  open() {
    ...
    modal.innerHTML = `
      <div class="glass-card rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col glow-pink hover-lift">
        <!-- Header -->
        <div class="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 gradient-animated text-white p-6 relative overflow-hidden">
