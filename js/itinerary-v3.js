...
function renderDayOverview(day){
  ...
  container.innerHTML = `
    ${cityImage ? `
      <div class="relative w-full rounded-t-xl -mx-6 -mt-6 mb-4 overflow-hidden" style="height: 240px;">
        <img src="${cityImage}" alt="${day.city || day.location || 'Japan'}" class="w-full h-full object-cover" style="object-position: center;" loading="lazy">
