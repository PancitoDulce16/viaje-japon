...
export const APIsIntegration = {
  ...
  /**
   * Buscar información de vuelo por número usando AviationStack
   * @param {string} flightNumber - Número de vuelo IATA (ej: "AM58")
  ...
  async searchFlights(flightNumber, date = null) {
    try {
      console.log('🔍 === SEARCH FLIGHTS (AviationStack) ===');
      console.log('📋 Parámetros:', { flightNumber, date });

      const url = API_ENDPOINTS.flights.search({ flight_iata: flightNumber });
