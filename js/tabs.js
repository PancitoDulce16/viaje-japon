        ...
        container.innerHTML = `
            <div class="max-w-6xl mx-auto p-4 md:p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <!-- Conversor de Moneda -->
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl shadow-lg p-6 border-2 border-emerald-200 dark:border-emerald-600">
                        <h3 class="text-xl font-bold mb-4 text-emerald-800 dark:text-emerald-300 flex items-center gap-2">
                            💸 Conversor de Moneda
                        </h3>
                        <div class="space-y-3">
                            <div class="flex gap-2">
