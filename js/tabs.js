        ...
        container.innerHTML = `
            <div class="max-w-6xl mx-auto p-4 md:p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <!-- Conversor de Moneda -->
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-gray-800 dark:to-gray-800 rounded-xl shadow-lg p-6 border-2 border-emerald-200 dark:border-emerald-500">
                        <h3 class="text-xl font-bold mb-4 text-emerald-800 dark:text-emerald-400 flex items-center gap-2">
                            💸 Conversor de Moneda
                        </h3>
                        <div class="space-y-3">
                            <div class="flex gap-2">
                                <div class="flex-1">
                                    <label class="text-xs text-emerald-700 dark:text-emerald-400 block mb-1 font-semibold">💵 USD (Dólares)</label>
                                    <input
                                        id="usdInput"
                                        type="number"
                                ...
                                <div class="flex-1">
                                    <label class="text-xs text-emerald-700 dark:text-emerald-400 block mb-1 font-semibold">💴 JPY (Yenes)</label>
                                    <input
                                        id="jpyInput"
                                        type="number"
                                        class="w-full p-3 border-2 border-emerald-300 rounded-lg bg-white dark:bg-gray-800 dark:border-emerald-600 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:placeholder-gray-500 font-semibold text-lg"
                            ...
                            <div class="flex items-center justify-center gap-2 bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                <p class="text-xs text-emerald-700 dark:text-emerald-400 exchange-rate-text font-bold">
