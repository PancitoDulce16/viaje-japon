...
import { collection, doc, setDoc, getDoc, getDocs, updateDoc, deleteDoc, query, where, onSnapshot, orderBy, serverTimestamp, increment } from 'firebase/firestore';

export const SocialFeatures = {
    currentTripId: null,
    unsubscribers: [],

    // Nota: el sistema de logros que vivía aquí (checkAndUpdateAchievements,
    // getUserStats, renderAchievements, loadAchievements) se retiró — era
    // una segunda implementación independiente de lo mismo que
    // gamification-system.js hacía. La implementación canónica única
    // ahora es js/features/achievements/achievements.js (window.Achievements),
    // ver OBJECT_BIBLE.md y ARCHITECTURE_PRINCIPLES.md. Los call-sites que
    // usaban esto (js/utils/utils-handler.js) apuntan directo a
    // window.Achievements. Ver DEPRECATION_LOG.md.
