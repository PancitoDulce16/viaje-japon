...
Existing code this replaces: **directly supersedes `js/features/gamification/gamification-system.js` and `challenge-system.js`** — those are points/levels/challenges and are explicitly the pattern this object rejects. Phase 2 implementation should treat their content model (not their scoring model) as a migration source.
